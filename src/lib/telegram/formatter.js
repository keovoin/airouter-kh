...
export function helpText() {
  return [
    ...
    "",
    "<b>Smart media</b> — send directly:",
    "• <b>Photo</b> — bot analyzes/describes it (add caption as question)",
    "• <b>File/doc</b> — bot reads &amp; summarizes (PDF, code, CSV, JSON...)",
    "• <b>Voice message</b> — bot transcribes &amp; responds",
    "",
    "<b>Content tools</b>",
    ...
    "<code>/song &lt;topic&gt;</code>            — write a song (--genre, --mood, --lang)",
    "<code>/setlang &lt;code&gt;</code>          — set default output language",
    "",
    "<b>Media generation</b>",
    "<code>/img &lt;prompt&gt;</code>           — generate image",
    "<code>/say &lt;text&gt;</code>             — text-to-speech",
    "<code>/song &lt;topic&gt;</code>           — write song lyrics (+audio if available)",
    ...
    "",
    "<b>Daily digest</b>",
    "<code>/digest</code>               — show config &amp; options",
    "<code>/digest on</code>            — enable daily morning briefing",
    "<code>/digest now</code>           — send one right now",
    "<code>/digest time 8</code>        — set delivery hour",
